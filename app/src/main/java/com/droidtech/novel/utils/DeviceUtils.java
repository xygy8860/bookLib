...
public class DeviceUtils {
    ...
    public static String getIMEI(Context context) {
        ...
        if (TextUtils.isEmpty(IMEI)) {
            IMEI = SharedPreferencesUtil.getInstance().getString("imei", null);
            if (TextUtils.isEmpty(IMEI)) {
                IMEI = getRandomBetweenNumbers(10000, 99999) + "" + getRandomBetweenNumbers(10000, 99999) + getRandomBetweenNumbers(10000, 99999);
                SharedPreferencesUtil.getInstance().putString("imei", IMEI);
            }
        }
