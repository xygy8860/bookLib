...
import com.droidtech.novel.ui.adapter.AutoCompleteAdapter;
import com.droidtech.novel.ui.adapter.SearchHistoryAdapter;
import com.droidtech.novel.ui.contract.SearchContract;
import com.droidtech.novel.ui.easyadapter.SearchAdapter;
import com.droidtech.novel.ui.presenter.SearchPresenter;
...
public class SearchActivity extends BaseRVActivity<SearchDetail.SearchBooks> implements SearchContract.View {
    ...
    @BindView(R2.id.tvChangeWords)
    TextView mTvChangeWords;
    @BindView(R2.id.tag_group)
    TagGroup mTagGroup;
    @BindView(R2.id.rootLayout)
    LinearLayout mRootLayout;
    @BindView(R2.id.layoutHotWord)
    RelativeLayout mLayoutHotWord;
    @BindView(R2.id.rlHistory)
    RelativeLayout rlHistory;
    @BindView(R2.id.tvClear)
    TextView tvClear;
    @BindView(R2.id.lvSearchHistory)
