...
import com.droidtech.novel.bean.support.TagEvent;
...
import com.droidtech.novel.ui.adapter.SubjectTagsAdapter;
import com.droidtech.novel.ui.contract.SubjectBookListContract;
import com.droidtech.novel.ui.fragment.SubjectFragment;
import com.droidtech.novel.ui.presenter.SubjectBookListPresenter;
import com.droidtech.novel.utils.ToastUtils;
import com.droidtech.novel.view.RVPIndicator;
import com.droidtech.novel.view.ReboundScrollView;
...
public class SubjectBookListActivity extends BaseActivity implements SubjectBookListContract.View, OnRvItemClickListener<String> {
    ...
    @BindView(R2.id.indicatorSubject)
    RVPIndicator mIndicator;
    @BindView(R2.id.viewpagerSubject)
    ViewPager mViewPager;
    @BindView(R2.id.rsvTags)
    ReboundScrollView rsvTags;

    @BindView(R2.id.rvTags)
    RecyclerView rvTags;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == R2.id.menu_tags) {
            ...
            return true;
        } else if (item.getItemId() == R2.id.menu_my_book_list) {
