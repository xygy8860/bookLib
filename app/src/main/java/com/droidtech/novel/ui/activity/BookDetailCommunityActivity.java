...
import com.droidtech.novel.bean.support.SelectionEvent;
...
public class BookDetailCommunityActivity extends BaseActivity {
    ...
    @BindView(R2.id.indicatorSubRank)
    RVPIndicator mIndicator;
    @BindView(R2.id.viewpagerSubRank)
    ...
    public int getLayoutId() {
        return R.layout.book_activity_book_detail_community;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == R2.id.action_sort) {
            showSortDialog();
            return true;
        }
