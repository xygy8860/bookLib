...
import com.droidtech.novel.bean.support.UserSexChooseFinishedEvent;
 ...
 * 本地阅读
 */
public class LocalReaderFragment extends BaseRVFragment<RecommendPresenter, Recommend.RecommendBooks> implements RecommendContract.View, RecyclerArrayAdapter.OnItemLongClickListener {

    @BindView(R2.id.llBatchManagement)
            ...
            public void onBindView(View headerView) {
                headerView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        TopCategoryListFragment.startFragmentActivity(activity);
                    }
                });
            }
        });
